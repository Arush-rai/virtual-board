...
const ViewLectures = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 p-8">
      <div className="max-w-5xl mx-auto bg-white/90 shadow-2xl rounded-3xl p-8 border border-purple-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {recordings.map((recording, idx) => (
            <div key={recording._id || idx} className="border-2 border-purple-200 rounded-2xl shadow-lg p-6 bg-gradient-to-br from-purple-50 to-pink-50 flex flex-col hover:shadow-2xl transition-shadow">
              ...
              {recording.webcamUrl && (
                <div className="mb-3">
                  <h3 className="text-md font-semibold text-purple-800 mb-1">Webcam Recording</h3>
                  <video controls className="w-full rounded-lg shadow-md border border-pink-200">
