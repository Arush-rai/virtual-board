      ...
      if (!ISSERVER) {
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}/student/authenticate`, values)
          .then((res) => {
            ...
            router.push('/student/browse-classroom');
          }).catch((err) => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 px-4 py-12">
      <div className="max-w-md w-full bg-white/90 rounded-3xl shadow-2xl border border-purple-200 p-8">
        ...
        <div className="mt-8 flex flex-col items-center">
          <span className="text-xs text-gray-400 uppercase mb-4">or sign in with</span>
          <button
            type="button"
            className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow hover:bg-gray-50 transition"
          >
