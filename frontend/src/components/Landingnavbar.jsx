      ...
      {menuOpen && (
        <div className="sm:hidden px-4 pb-4">
          <div className="flex flex-col gap-3">
            ...
            {/* Student Dropdown for mobile */}
            <details className="w-full" open={studentOpen}>
              <summary
                className="bg-white text-purple-600 font-bold px-4 py-2 rounded-lg shadow hover:bg-purple-100 transition-colors cursor-pointer"
                onClick={e => {
                  e.preventDefault();
                  setStudentOpen((prev) => !prev);
                  setTeacherOpen(false);
            ...
            {/* Teacher Dropdown for mobile */}
            <details className="w-full" open={teacherOpen}>
              <summary
                className="bg-white text-pink-600 font-bold px-4 py-2 rounded-lg shadow hover:bg-pink-100 transition-colors cursor-pointer"
                onClick={e => {
                  e.preventDefault();
                  setTeacherOpen((prev) => !prev);
                  setStudentOpen(false);
